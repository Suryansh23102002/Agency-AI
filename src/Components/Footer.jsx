      ...
      <div className="flex justify-between lg:items-center max-lg:flex-col gap-10">
        ...
        className='text-gray-600 dark:text-gray-400'>
          ...
          <div className='flex gap-2 text-sm'>
              <input placeholder="Enter your email" className="w-full p-3 text-sm outline-none rounded dark:text-gray-200 bg-transparent border border-gray-300 dark:border-gray-500" type="email"></input>
              <button className="bg-primary text-white rounded px-6">Subscribe</button>
          </div>
        </motion.div>
      </div>
      <hr class="border-gray-300 dark:border-gray-600 my-6"></hr>
      <motion.div 
      initial={{opacity:0}}
